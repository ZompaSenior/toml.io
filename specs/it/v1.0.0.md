...
Di Tom Preston-Werner, Pradyun Gedam, e al.
...
TOML vuole essere un formato di file di configurazione minimale di facile lettura grazie aa una semantica evidente. TOML � progettato per mappare in modo inequivocabile una tabella hash. TOML dovrebbe essere facile da parsare in strutture di dati in un'ampia variet� di linguaggi.
...
- [Specifiche](#spec)
- [Commenti](#comment)
- [Coppie Chiave/Valore](#keyvalue-pair)
- [Chiavi](#keys)
- [String](#string)
- [Integer](#integer)
- [Float](#float)
